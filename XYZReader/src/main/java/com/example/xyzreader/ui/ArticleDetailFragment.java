...
public class ArticleDetailFragment extends Fragment implements
    ...
    private void bindViews() {
        ...
        if (mCursor != null) {
            ...
            bodyView.setTypeface(ResourcesCompat.getFont(mRootView.getContext(), R.font.rosario_regular));
            ...
            Glide.with(mRootView.getContext())
                    ...
                    .listener(new RequestListener<Bitmap>() {
                        ...
                        public boolean onResourceReady(Bitmap resource, Object model, Target<Bitmap> target, DataSource dataSource, boolean isFirstResource) {
                            if (resource != null && isAdded()) {
                                Palette p = Palette.from(resource).generate();
                                mMutedColor = p.getDarkMutedColor(getResources().getColor(R.color.secondaryColor));
                    ...
                    .get(mCursor.getString(ArticleLoader.Query.PHOTO_URL), new ImageLoader.ImageListener() {
                        ...
                        public void onResponse(ImageLoader.ImageContainer imageContainer, boolean b) {
                            ...
                            if (bitmap != null) {
                                ...
                                mMutedColor = p.getDarkVibrantColor(getResources().getColor(R.color.secondaryColor));
